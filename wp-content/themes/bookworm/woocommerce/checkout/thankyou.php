...
<div>
    <div class="bg-white">
        <div class="woocommerce-order">
            ...
            <?php endif; ?>
                <p class="message-notify text-center">Đơn hàng <span class="code-order"><?php echo $order->get_id() ?></span> đang được xử lý!<br>
                    Trân trọng cảm ơn quý khách đã mua hàng tại Cánh Diều!<br>
                    Chúc quý khách ngày mới vui vẻ!</p>

                <div class="border area-banks">
                    <div class="flex items-center">
                        <h6>Thông tin chuyển khoản</h6>
                        <div>
                            Số tiền thanh toán
                            <strong><?php echo number_format($order->get_total()). ' '.$order->get_currency() ?></strong>
                        </div>
                    </div>
                    <div class="bank-detail">
                        ...
                        if($bacs_accounts_info)
                            foreach ($bacs_accounts_info as $bank){
                                ?>
                                <div class="item <?php echo str_replace(' ', '', $bank->bank_name)?>">
                                    <p><?php echo $bank['account_name']?></p>
                                    <p>STK: <?php echo $bank['account_number']?></p>
                                    <p>Nội dung CK: <?php echo $order->get_id()?></p>
                                </div>
